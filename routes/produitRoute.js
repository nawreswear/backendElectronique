...
const { nomProd,prixProd, imgProd,quantProd,statusProd,refProd,descrpProd,categorieID,marqueID} = req.body;
const newProduit = new Produit({nomProd:nomProd,prixProd:prixProd, imgProd:imgProd,
   quantProd:quantProd,statusProd:statusProd,refProd:refProd,categorieID:categorieID,marqueID:marqueID,
